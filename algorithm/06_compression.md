...
class Solution {
    ...
    public String getSplitedLength(String s, int i, int repeat){
        ...
        if(!postString.startsWith(preString)){
            if(repeat == 1) return result += preString + getSplitedLength(postString, i, 1);
            return result += Integer.toString(repeat) + preString + getSplitedLength(postString, i, 1);
        }
        return result += getSplitedLength(postString, i, repeat+1);
